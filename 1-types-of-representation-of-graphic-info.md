...
| 7 | ![Дорожки](./images/lane.png) | **Дорожки** | Используются для разграничения зон ответственности участников бизнес-процесса. Любые элементы схем в нотации, размещенные на той или иной дорожке, будут выполняться конкретными исполнителями. |
